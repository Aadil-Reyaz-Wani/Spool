        ...
        text = {
            Column(
                ...
                SpoolOutlinedTextField(
                    ...
                    label = stringResource(Res.string.label_deduct_weight),
                ...
                SpoolOutlinedTextField(
                    value = uiState.printTitle,
                    onValueChange = onPrintTitleValueChange,
                    label = stringResource(Res.string.label_print_title),
                    placeholder = stringResource(Res.string.hint_print_title),
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(Res.string.check_failure),
                        style = MaterialTheme.typography.labelLarge.copy(fontSize = Dimens.RegularTextSize)
                    )

                    Switch(
                        checked = uiState.isFailed,
