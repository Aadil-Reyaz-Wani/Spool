...
import com.aadil.spool.AppConfig
...
fun AboutScreen(
    ...
    Scaffold(
        topBar = {
            SpoolAppBar(
                title = stringResource(Res.string.about_screen_label),
        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(Res.string.our_mission_header_label),
                            style = MaterialTheme.typography.titleMedium,
                            fontWeight = FontWeight.Bold
                        )
                    }
                    Text(
                        text = stringResource(Res.string.our_mission_slogan),
            ...
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column {
                            Text(
                                text = stringResource(Res.string.created_by_label),
                                style = MaterialTheme.typography.labelMedium,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                                text = stringResource(Res.string.creator_label),
                                style = MaterialTheme.typography.titleMedium,
                                fontWeight = FontWeight.Bold,
                                color = MaterialTheme.colorScheme.onSurface
                            )
                    ...
                    // Social Links
                    DeveloperLinkItem(
                        label = stringResource(Res.string.social_x),
                        icon = Icons.Outlined.Link,
                        onClick = { uriHandler.openUri("https://x.com/_aadil_114") }
                    )
                    DeveloperLinkItem(
                        label = stringResource(Res.string.social_linkedin),
                        icon = Icons.Outlined.Link,
            ...
            // Rate & Review Button
            SpoolButton(
                text = stringResource(Res.string.rating_button_label),
                icon = Icons.Default.Star,
                onClick = { uriHandler.openUri("https://play.google.com/store/apps/details?id=com.aadil.spool") }
            )
            ...
            Row(
                ...
                TextButton(onClick = onOpenSourceLicenseClick) {
                    Text(
                        text = stringResource(Res.string.open_source_licenses_label),
                        style = MaterialTheme.typography.labelMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
                Text(
                    text = stringResource(Res.string.dot_separator_label),
